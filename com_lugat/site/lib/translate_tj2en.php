...
$tbl_cloud="testdb_lugat_tagcloud_tj2en";
if (isset($_GET['SearchWord'])) {
	...
	if( $len > 0 ) {
		...
		$sql="SELECT en from testdb_lugat_tj2en_v01 WHERE `tj`='".$t."'";
		$result = mysql_query($sql,$conn);
		if(!$result){
			echo "Can't load from the Tajik-English dictionary <br/>".mysql_error()."<br/>";
			return;
		}
		$string = '';
